...
Import-Module Az.Aks -RequiredVersion 3.0.0 -Global
...
Import-Module Az.Automation -RequiredVersion 1.7.2 -Global
...
Import-Module Az.Compute -RequiredVersion 4.21.0 -Global
...
Import-Module Az.Functions -RequiredVersion 4.0.0 -Global
...
Import-Module Az.KeyVault -RequiredVersion 4.1.0 -Global
...
Import-Module Az.Network -RequiredVersion 4.13.0 -Global
...
Import-Module Az.RedisCache -RequiredVersion 1.5.1 -Global
...
Import-Module Az.Resources -RequiredVersion 5.1.0 -Global
...
Import-Module Az.SignalR -RequiredVersion 1.4.0 -Global
Import-Module Az.Sql -RequiredVersion 3.6.0 -Global
Import-Module Az.SqlVirtualMachine -RequiredVersion 1.1.0 -Global
Import-Module Az.StackHCI -RequiredVersion 1.0.0 -Global
Import-Module Az.Storage -RequiredVersion 4.1.0 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALkq+IFJv4U27X
# mw6PTlf71agOxJrr+xEBniwHe7ftqqCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgigx7/BJn
# XDm78YsMGRpnsusN96F5BvRSM7xGL1amRVswQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAn7qe73arDk0ak1XA/oNUrgSzSyjLq0rdElv6HZDxn
# XlGfHZkZYoNhSh7bcv79j0SAFC49ZfzjmVmIl5sYlBYTZAl6bdmDekMUaPMn2CiM
# jGjh59NaOWF74SlDl+IjegPdnd8zrZbkjtqPapn74q+Id78l2ITqRPcSYlJEKxhu
# 3FwaTpG5XW8W5rbD2E4Hy6HseJmDsQ0CCHww9kbe44RpnvzG5l7pdnI8l9SJq7W9
# sHk5pAPTsW8TVvGWCFza8oL/UVh2eajI80Uyweal8iQnl1hKNR4EacGuhi2wSrMn
# Yvrp9j1UAGsnrpdjDY7RrPZtsHGYX5WQRYwM2Qn8mdc4oYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIK703/bXZig9hPto9K3i2S3S3YS03j8eApFygJae
# /HTkAgZhkuD7WtEYEzIwMjExMjAyMTAwNDIxLjc2M1owBIACAfSggdCkgc0wgcox
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgQ/WUI+ah
# PvyFt4dVDARAO6uO+UESTb7IXH2wuoSWFK0wgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIIBAE7j6LNRJZ0j9PpTB2b4l85AyNXvL+CpeNpt03gL4+pPYFyKBHXv
# W+CxL9kjRCAms73re2BmRYuJqeZApLYYG+HAKLqtntzYYLrKnhl4aopeo+2sqt5s
# 6LtlCXze6Ykbz/HshhzQRPWsu2BslxTb2aYuzMbdkRnb0oFFbolg/FA6e5BdytRx
# 37s+sXQXNFtmunuf8va2r7YKfd5Nfyiu1mdIwF8ZVC8EdIoWRCp51O5O+8BDkgdo
# ygqc5ncwsTFf2e8/RJbVyBlxMy57jNvZ3sCNieZ0NjJDedvM+4pZXwIUyjngOPsZ
# laIZBb5cSsy3R0E2GfxE0L3GRnZiTDTi8Rc=
